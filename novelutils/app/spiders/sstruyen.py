...
class SSTruyenSpider(scrapy.Spider):
    ...
    def parse(self, response: scrapy.http.Response, **kwargs):
        """Extract info of the novel and get the link of the start chapter.
        ...
        """
        # get cover
        cover_link = self.base_url + response.xpath('/html/body/div[5]/div/div/div[1]/div[1]/div['
                                                    '1]/img/@data-src').get().replace('//', '/')
...
def get_info(response: scrapy.http.Response, save_path: Path):
    ...
    types = response.xpath('/html/body/div[5]/div/div/div[1]/div[1]/div[2]/div[3]/div/p[2]/a/text()').getall()
    foreword = response.xpath('/html/body/div[5]/div/div/div[1]/div[1]/div[2]/div[3]/p//text()').getall()
    info = list()
    info.append(title)
    info.append(author)
